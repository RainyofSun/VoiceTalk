//
//  VTThreadSafeMutableDictionary.m
//  VoiceTalk
//
...
@interface VTThreadSafeMutableDictionary ()
{
...
@implementation VTThreadSafeMutableDictionary
...
- (BOOL)isEqualToDictionary:(NSDictionary *)otherDictionary {
    ...
    if ([otherDictionary isKindOfClass:VTThreadSafeMutableDictionary.class]) {
        VTThreadSafeMutableDictionary *other = (id)otherDictionary;
        BOOL isEqual;
...
- (BOOL)isEqual:(id)object {
    ...
    if ([object isKindOfClass:VTThreadSafeMutableDictionary.class]) {
        VTThreadSafeMutableDictionary *other = object;
        BOOL isEqual;
        pthread_mutex_lock(&_lock);
        pthread_mutex_lock(&other->_lock);
        isEqual = [_dic isEqual:other->_dic];
